...
#ifdef HAVE_PPL
std::shared_ptr<AudioData const> AudioCache::LoadFromFileAsync(const std::filesystem::path & path, concurrency::task_group & taskGroup)
{
    std::shared_ptr<AudioData const> audio;
